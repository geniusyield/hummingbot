...
class GeniusYieldConfigMap(BaseConnectorConfigMap):
    connector: str = Field(default="genius_yield", const=True, client_data=None)
...
KEYS = GeniusYieldConfigMap.construct()
