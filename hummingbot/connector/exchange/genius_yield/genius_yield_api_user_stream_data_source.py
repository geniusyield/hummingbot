...
class GeniusYieldAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    async def _subscribe_channels(self, websocket_assistant: WSAssistant):
        ...
        Genius Yield does not require any channel subscription.
    ...
    async def _get_listen_key(self):
        ...
        try:
            data = await rest_assistant.execute_request(
                url=web_utils.public_rest_url(path_url=CONSTANTS.GENIUS_YIELD_USER_STREAM_PATH_URL, domain=self._domain),
