...
class GeniusYieldOrderBookTests(TestCase):

    def test_snapshot_message_from_exchange(self):
        snapshot_message = GeniusYieldOrderBook.snapshot_message_from_exchange(
            msg={
                "lastUpdateId": 1,
                "bids": [
    ...
    def test_diff_message_from_exchange(self):
        diff_msg = GeniusYieldOrderBook.diff_message_from_exchange(
            msg={
                "e": "depthUpdate",
                "E": 123456789,
                "s": "COINALPHAHBOT",
