...
from hummingbot.connector.exchange.genius_yield.genius_yield_api_user_stream_data_source import GeniusYieldAPIUserStreamDataSource
...
class GeniusYieldUserStreamDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.auth = GeniusYieldAuth(api_key="TEST_API_KEY", secret_key="TEST_SECRET", time_provider=self.mock_time_provider)
        self.time_synchronizer = TimeSynchronizer()
        self.time_synchronizer.add_time_offset_ms_sample(0)

        client_config_map = ClientConfigAdapter(ClientConfigMap())
        self.connector = GeniusYieldExchange(
            client_config_map=client_config_map,
            genius_yield_api_key="",
            genius_yield_api_secret="",
            trading_pairs=[],
            trading_required=False,
            domain=self.domain)
        self.connector._web_assistants_factory._auth = self.auth

        self.data_source = GeniusYieldAPIUserStreamDataSource(
            auth=self.auth,
    ...
    @patch("hummingbot.connector.exchange.genius_yield.genius_yield_api_user_stream_data_source.GeniusYieldAPIUserStreamDataSource"
           "._ping_listen_key",
