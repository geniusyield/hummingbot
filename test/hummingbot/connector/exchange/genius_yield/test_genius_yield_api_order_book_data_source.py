...
class GeniusYieldAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.connector = GeniusYieldExchange(
            ...
            domain=self.domain)
        self.data_source = GeniusYieldAPIOrderBookDataSource(trading_pairs=[self.trading_pair],
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.genius_yield.genius_yield_api_order_book_data_source"
           ".GeniusYieldAPIOrderBookDataSource._sleep")
